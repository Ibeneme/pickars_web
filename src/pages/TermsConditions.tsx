...
const TermsAndConditionsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] pt-[140px] md:pt-[180px] font-['Lufga'] py-16 md:py-24 px-5 md:px-12">
      <Helmet>
        <title>Terms of Service | Pickars Courier Limited</title>
        <meta
          name="description"
          content="Official Terms of Service for Pickars Courier Limited – the technology platform connecting customers with independent dispatch riders in Port Harcourt, Nigeria."
        />
            ...
            <section className="space-y-10">
              ...
              <div className="text-center pt-6">
                ...
                <p className="mt-6 text-sm text-gray-400">
                  ...
                  <br />
                  Email: support@pickars.com | support@pickars.com
                </p>
              </div>
            </section>
          </main>
