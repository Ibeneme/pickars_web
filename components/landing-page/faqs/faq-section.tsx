          ...
          <div className="lg:col-span-5">
            <div className="sticky top-28 flex flex-col items-start">
              ...
              <motion.div
                ...
                className="mb-6 sm:mb-10 px-5 sm:px-6 py-2 sm:py-2.5 bg-[#FF0000] text-white font-black text-[11px] sm:text-xs md:text-sm uppercase tracking-widest cursor-default select-none"
                style={{
                  maskImage:
