...
import phone_a from "@/assets/landing-page-images/app-mockups/phone_a.svg";
import phone_b from "@/assets/landing-page-images/app-mockups/phone_b.svg";
import phone_c from "@/assets/landing-page-images/app-mockups/phone_c.svg";
import phone_d from "@/assets/landing-page-images/app-mockups/phone_d.svg";
...
export default function AppFeaturesMockup() {
  ...
  return (
    <div className="min-h-screen bg-[#000] py-12 flex flex-col items-center justify-center p-4 ">
      <div className="w-full max-w-6xl bg-black text-white rounded-3xl border border-red-900/50 flex flex-col justify-between p-8 md:p-16 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-8">
          ...
          <div className="md:col-span-6 flex items-center justify-center">
            <div className="w-full max-w-lg h-[600px] sm:h-[650px] flex items-center justify-center overflow-hidden relative">
              <Image
